...
* XS 857 smtp.exmail.qq.com:25 535 Error: authentication failed, system busy 
由于登录数据无效因此未交付至 bin.xu@a123systems.com
![alt text](image-105.png)
需要客户端专用密码![alt text](image-104.png)
[发送邮件报错：535, 'Error: authentication failed, system busy'](https://www.cnblogs.com/SZxiaochun/p/11214625.html)
